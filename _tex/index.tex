...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, arc=.35mm, breakable, colframe=quarto-callout-note-color-frame, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, colback=white, left=2mm, toptitle=1mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, arc=.35mm, breakable, colframe=quarto-callout-tip-color-frame, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, colback=white, left=2mm, toptitle=1mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white, opacityback=0, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, arc=.35mm, breakable, colframe=quarto-callout-important-color-frame, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, colback=white, left=2mm, toptitle=1mm, rightrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, leftrule=.75mm, colbacktitle=quarto-callout-important-color!10!white, opacityback=0, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, arc=.35mm, breakable, colframe=quarto-callout-tip-color-frame, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, colback=white, left=2mm, toptitle=1mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Exercise}, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white, opacityback=0, opacitybacktitle=0.6]
...
is the so-called ``self-gain'' of the MOSFET, and shows the maximum
voltage gain we can achieve in a single transistor configuration. As one
can see the self gain increases for increasing \(L\), but this also
gives a slower transistor, so again there is a trade-off. This plot
allows us to select the proper \(L\) of a MOSFET if we know which amount
of self gain we need.
...
as a function of \(g_\mathrm{m}/g_\mathrm{ds}\) and \(L\). With this
plot we can find out how to set the \(W\) of a MOSFET once we know the
...
\(g_\mathrm{m}/I_\mathrm{D} \ge 10\), wheres for fast circuits we need
to go to small \(g_\mathrm{m}/I_\mathrm{D} \le 5\) requiring substantial
...
\(g_\mathrm{m}/g_\mathrm{ds}\) and \(L\):
...
current mirror, which we will investigate in a future section. This
diode is usually biased by a current source, shown as
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, arc=.35mm, breakable, colframe=quarto-callout-tip-color-frame, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, colback=white, left=2mm, toptitle=1mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Solution}, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white, opacityback=0, opacitybacktitle=0.6]
