...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, toprule=.15mm, leftrule=.75mm, breakable, coltitle=black, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, left=2mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, toptitle=1mm, arc=.35mm, colback=white, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, toprule=.15mm, leftrule=.75mm, breakable, coltitle=black, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, left=2mm, opacityback=0, colbacktitle=quarto-callout-important-color!10!white, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, toptitle=1mm, arc=.35mm, colback=white, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, toprule=.15mm, leftrule=.75mm, breakable, coltitle=black, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Exercise}, left=2mm, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, toptitle=1mm, arc=.35mm, colback=white, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, toprule=.15mm, leftrule=.75mm, breakable, coltitle=black, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Solution}, left=2mm, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, toptitle=1mm, arc=.35mm, colback=white, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, toprule=.15mm, leftrule=.75mm, breakable, coltitle=black, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Useful Integral for Noise Calculations}, left=2mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, toptitle=1mm, arc=.35mm, colback=white, bottomrule=.15mm]
...
have the same \(W \& L\) dimensionsing. \(M_{5,6}\) we scale accordingly
to set the correct bias current in the OTA.
...
\item
  ...
  \(V_\mathrm{GS5} = V_\mathrm{in} - V_\mathrm{GS1} = 1.1 - 0.6 = 0.5\,\text{V}\),
...
temperature variation we will strive for \(A_0 = 30\,\text{dB}\)
...
\item
  The drain capacitance of \(M_2\) and \(M_4\) we can add to the load
  capacitance \(C_\mathrm{load}\).
\end{itemize}
...
For repetition and as a reference, here the simplified relationships for
the common-source, common-gate, and the common-drain single transistor
stages:
...
\] which is plausible, and confirms the requirement of a high impedance
at the output node. For very large frequencies we get
...
We see that the feedback around the transconductor \(g_\mathrm{m}\)
creates an impedance of \(1/g_\mathrm{m}\). We can now calculate the
effective load conductance of \[
Y'_\mathrm{load} = g_\mathrm{ds2} + g_\mathrm{ds4} + s C_\mathrm{load} + g_\mathrm{m}\approx g_\mathrm{m}+ s C_\mathrm{load}.
\]

The output noise voltage is then \[
\overline{V_\mathrm{n,out}^2}(s) = \frac{\overline{I_\mathrm{n}^2}}{|g_\mathrm{m}+ s C_\mathrm{load}|^2} = 
\]
