...
Second, $\vgs[34]$ is subsituted by @eq-app-vbufzout-vgs34-ol. Since we have assumed a matched pair of transistors for the current mirror comprised of $M_3$ and $M_4$, $\gm[34]$ perfectly cancels out of the equation, and is effectively replaced by the transconductance $\gm[1]$ of the input transistor $M_1$.
$$
...
Using @eq-app-vbufzout-kvl-vout-cl to subsitite $\vgs[2]$ in {#eq-app-vbufzout-kcl-vtail-cl} we find an equation for $\vgs[1]$.
$$
