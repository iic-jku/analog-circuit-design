...
| MOSFET `sg13_lv_nmos` | $\sdev[\Delta \Vth] \cdot \sqrt{WL}$  | 2 mV µm            |
| MOSFET `sg13_lv_nmos` | $\sdev[\Delta W]$                     | 4 nm               |
| MOSFET `sg13_lv_nmos` | $\sdev[\Delta L]$                     | 2 nm               |
| MOSFET `sg13_lv_nmos` | $\sdev[\Delta \mu/\mu]$               | 1 %                |
| MOSFET `sg13_lv_pmos` | $\sdev[\Delta \Vth] \cdot \sqrt{WL}$  | 2.5 mV µm          |
| MOSFET `sg13_lv_pmos` | $\sdev[\Delta W]$                     | 5 nm               |
| MOSFET `sg13_lv_pmos` | $\sdev[\Delta L]$                     | 1.5 nm             |
| MOSFET `sg13_lv_pmos` | $\sdev[\Delta \mu/\mu]$               | 0.5 %              |
...
$$
\sdev[\frac{\Delta K}{K}] = \sqrt{ \left( \frac{4\,\text{nm}}{10\,\mu\text{m}} \right)^2 + \left( \frac{2\,\text{nm}}{5\,\mu\text{m}} \right)^2 + (1\,\%)^2 } = 1.00\,\%.
$$
...
$$
\sdev[\frac{\Delta \ID}{\ID}] = \sqrt{ (0.28\,\text{mV} \cdot 5\,\text{V}^{-1})^2 + (1.00\,\%)^2} \approx 1\,\%.
$$
...
$$
\sdev[\frac{\Delta K}{K}] = \sqrt{ \left( \frac{4\,\text{nm}}{20\,\mu\text{m}} \right)^2 + \left( \frac{2\,\text{nm}}{3\,\mu\text{m}} \right)^2 + (1\,\%)^2 } = 1.00\,\%.
$$
