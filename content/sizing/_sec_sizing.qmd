...
During the design phase, it might be convenient to have an overview of the most relevant sizing plots of the NMOST on one page. This overview can be downloaded [here](./gmid/techsweep_sg13_plots_nmos_overview/techsweep_sg13_plots_nmos_overview.pdf).
...
During the design phase, it might be convenient to have an overview of the most relevant sizing plots of the PMOST on one page. This overview can be downloaded [here](./gmid/techsweep_sg13_plots_pmos_overview/techsweep_sg13_plots_pmos_overview.pdf).
