...
Here is an unsorted list of useful ngspice settings and commands:
...
Variables can be set using `set var=value` and accessed with `$var`. Useful internal variables are:
