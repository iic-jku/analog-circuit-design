...
As a home exercise, try to derive @eq-mosfet-transit-frequency starting from @fig-mosfet-small-signal-model-simplified. By showing this transformation you can prove that indeed both circuits are electrically equivalent.
::: 
