...
if the gain of the OTA is sufficiently high. The quiescent current through $R_{1,2}$ established a minimum load current for the LDO, which is often a good thing for stability. More information on LDOs can be found in [@Razavi_2019].
