...
#| echo: false
#| fig-cap: "5-transistor OTA open-loop small-signal model. For the closed-loop model, the input voltage $V_\\mathrm{in,n}$ is connected to the output voltage $V_\\mathrm{out}$."
...
with sd.Drawing(canvas='svg') as d:
    ...
    elm.Line().left().length(3).at(Cgs34.start)
