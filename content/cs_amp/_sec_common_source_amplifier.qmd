...
{{< include /content/cs_amp/_fig_cs_amplifier.qmd >}}
...
{{< include /content/cs_amp/_fig_meas_amplifier.qmd >}}
...
Please go through the [sizing notebook](./gmid/sizing_measurement_amplifier.ipynb) of the measurement amplifier and double-check the calculations. Do you agree that the calculations are correct?
