...
When designing switches, often the unwanted effects of charge injection and clock feed-through have to be considered and, as always, a trade-off has to be chosen. More details can be found in literature, e.g, [@Johns_Martin_2nd_ed] or [@Razavi_Analog_CMOS].
