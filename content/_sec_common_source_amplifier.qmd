...
As explained above, it is a good approach to see electronic circuits as voltage-to-current (transistor) and current-to-voltage (resistor) conversions for better understanding.
