...
The resulting circuit is shown in the following figure (the red input capacitor shows the $\Cgg$ of the MOSFET):

{{< embed ./sizing/sizing_measurement_amplifier.ipynb#fig-meas-amp-sized >}}
...
If you get stuck, [here](xschem/measurement_amplifier.sch) is the solution to this exercise.
:::
