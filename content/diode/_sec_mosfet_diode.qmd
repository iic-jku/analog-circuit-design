...
If we flip @fig-mos-diode-simulation by 90 degrees we can appreciate the name "MOSFET diode" as the characteristic resembles the one of a diode quite well (somewhat steep increase of the current beyond a certain threshold voltage). This is shown in @fig-mos-diode-simulation-rotated.
